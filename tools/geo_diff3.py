...
url1='http://gis-int.intsit.sfdc.com.cn:1080/geo/api'
url2='http://gis-int.intsit.sfdc.com.cn:1080/geo/api'
url3='http://gis-int.intsit.sfdc.com.cn:1080/geo/api'
...
class geo_Mutest(TestAbstract):
    ...
    def openfile(self,a):
        ...
        file2 = os.path.dirname(os.path.dirname(__file__)) + '/report' + '/' + 'geo_'+a + "_" + now + ".txt"
    ...
    def err(self, url2,url3,r1,r2,r3,p1,p2,p3):
        ...
        diff_post_ED = "e:/project/Interface_api-master/report/" + "diff_post加密与get对比_" + now + ".txt"
        diff_post = "e:/project/Interface_api-master/report/" + "diff_post非加密与get对比_" + now + ".txt"
    ...
    def empty(self, url2,url3,r1,r2,r3,p1,p2,p3):
        ...
        k=0
        now = time.strftime('%Y-%m-%d-%H-%M-%S', time.localtime(time.time()))
        empty_post_ED = "e:/project/Interface_api-master/report/" + "empty_post加密与get对比_" + now + ".txt"
        empty_post = "e:/project/Interface_api-master/report/" + "empty_post非加密与get对比_" + now + ".txt"
