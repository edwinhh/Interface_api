...
class v3_7(TestAbstract):
	def test_1(self):
		data = {'address': '广东省深圳市软件产业基地1栋A座', \
				'city':'', \
				'opt':'sf30',\
...
#
	...
	# 	p.append(data)
	# 	r.append(res)
	# 	print('11: ',res['result']['adname'][2])
	# 	self.assertEqual('', res['result']['adname'][2])
...
if __name__ == "__main__":
	...
	suite.addTest(unittest.makeSuite(v3_7))
