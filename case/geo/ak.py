...
url = 'http://gis-ass-oms-gk.sit.sf-express.com/pub/redis/getMap'
#url=geturl("geo")
ak=getak("ak")
...
class ak(TestAbstract):
	def test_1(self):
		data = {'key': '#PASS#|ADD-TC2|30292d603e6446e3ba8db55d273e7ec2|dayTrackOfMinute|20180725'}
...
if __name__ == "__main__":
	...
	suite.addTest(unittest.makeSuite(ak))
